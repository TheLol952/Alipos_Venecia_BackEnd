...
# Diccionario para registrar facturas no insertadas
            ...
            try:
                ...
                if not valid_json_part:
                    ...
                    if pdf_candidates:
                        ...
                        damaged_folder = ensure_damaged_folder()
...
if __name__ == "__main__":
    ...
    if facturas_no_insertadas:
        logging.warning(f"⚠️ Hay una discrepancia: {len(facturas_no_insertadas)} facturas no fueron insertadas.")
        logging.info(f"📄 Se ha generado el archivo 'facturas_no_insertadas.json' con los detalles.")
